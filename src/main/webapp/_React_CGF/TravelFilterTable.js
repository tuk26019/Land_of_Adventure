...
const TravelFilterTable = () => {
    ...
    console.log("TravelFilterTable running!!");
    ...
    React.useEffect(() => {
        ...
        ajax_alt(
            ...
            "experience/getAll", // URL for AJAX call to invoke
            ...
            function (dbList) {   // success function gets obj from ajax_alt
                if (dbList.dbError.length > 0) {
                    ...
                    console.log(dbList.travelList);
                    setDbList(dbList.travelList);
                    setFilteredList(dbList.travelList);
                }
    ...
    return (
        <div className="clickSort">
            <h3>
                Filterable Travel Experience List &nbsp;
                ...
                <thead>
                    <tr>
                        ...
                        <th className="textAlignCenter">
                            <img src="icons/blackSort.png" />Date
                        </th>
                ...
                <tbody>
                    {
                        filteredList.map((listObj) =>
                            <tr key={listObj.travelId}>
                                <td>{listObj.location}</td>
                                <td className="shadowImage textAlignCenter"><img src={listObj.image} /></td>
                                <td className="textAlignCenter">{listObj.date}</td>
                                <td className="textAlignRight">{listObj.cost}</td>
                                <td className="nowrap">{listObj.description}</td>
