...
public class DbMods {
    ...
    public static StringData getUserInfo(DbConn dbc, String email, String password) {
        ...
        try {
            ...
            sd.errorMsg = "Exception thrown in model/webUser/DbMods/getUserInfo(): " + e.getMessage();
        }
